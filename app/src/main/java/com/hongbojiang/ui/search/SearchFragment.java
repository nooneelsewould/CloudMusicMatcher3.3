...
public class SearchFragment extends Fragment {
    ...
    private static class SearchTaskAsync extends AsyncTask<Void, Void, List<Song>> {
        ...
        protected List<Song> doInBackground(Void... voids) {
            ...
            List<com.hongbojiang.proxy.Song> songs = new ArrayList<>();
            PlaylistAPIHelper playlistAPIHelper = new PlaylistAPIHelper(id);
            try {
                songs = playlistAPIHelper.getSongs();
            } catch (IOException e) {
                e.printStackTrace();
            }
            if (!songs.isEmpty()) {
                for (com.hongbojiang.proxy.Song item : songs) {
